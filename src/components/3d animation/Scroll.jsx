...
const SCROLL_LENGTH_VH = 800; // how many viewport-heights of scroll it takes to play the whole sequence

const FRAME_PATH = (index) => `/frames/Agrframes/ezgif-frame-${String(index + 1).padStart(3, "0")}.jpg`;
